 ...
 * contain them).
 */
export declare function _walkAndOverlayDynamicValues(query: OperationInstance, context: CacheContext, snapshot: GraphSnapshot, result: JsonObject | undefined, nodeIds?: Set<NodeId>): JsonObject | undefined;
/**
